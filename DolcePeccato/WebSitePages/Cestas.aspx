<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cestas.aspx.cs" 
Inherits="DolcePeccato.WEBUI.WebSitePages.ProdutoCestas" MasterPageFile="~/WebSitePages/Templates/master.Master" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#lista-produtos ul li').not('.cesta').remove();
...
<asp:Content ID="content" ContentPlaceHolderID="content" runat="server">
   ...
   <div id="filters">
        ...
        <a href="Cestas.aspx" class="filters-option active" id="cestas" title="Listar somente as cestas">Cestas</a>
